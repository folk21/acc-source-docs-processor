...
from source_docs_processor.features.document_processing.document_types.incoming_purchase_documents._internal.extractor import (
    extract_document,
)
from source_docs_processor.features.document_processing.document_types.incoming_purchase_documents._internal.readers import (
